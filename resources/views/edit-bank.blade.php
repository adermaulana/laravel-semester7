...
<body>
    <div class="container mt-5">
        ...
        <form action="/edit-bank/{{ $bank->id }}" method="post">
            @method('put')
            @csrf
            <div class="mb-3 col-4">
                <label for="exampleInputEmail1" class="form-label">Singkatan</label>
                <input value="{{ $bank->singkatan,old('singkatan') }}" type="text" name="singkatan" class=" @error('singkatan') is-invalid @enderror" id="exampleInputEmail1">
                @error('singkatan')
            ...
            <div class="mb-3 col-4">
                ...
                <input value="{{ $bank->nama_bank,old('nama_bank') }}" type="text" name="nama_bank" class="@error('nama_bank') is-invalid @enderror" id="exampleInputPassword1">
                @error('nama_bank')
                <div  class="invalid-feedback"> 
                    {{ $message }}
                </div>
